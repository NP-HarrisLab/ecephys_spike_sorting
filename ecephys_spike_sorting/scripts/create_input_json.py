...
def create_samba_directory(samba_server, samba_share):
    ...
    if sys.platform == "linux":
        ...
        data_dir = os.path.join(
            "/", "var", "run", "user", proc_owner_uid, "gvfs", share_string
        )
    else:
...
def createInputJson(
    ...
    ecephys_directory = params[
        "ecephys_directory"
    ]  # r"C:\Users\labadmin\Documents\ecephys_anaconda\ecephys_spike_sorting\ecephys_spike_sorting"
    ...
    if ks_ver == "2.0":
        ...
        kilosort_repository = params[
            "kilosort_25_repository"
        ]  # r"C:\Users\labadmin\Documents\Kilosort-2.5.2"
    elif ks_ver == "3.0":
        kilosort_repository = r"C:\Users\labadmin\Documents\KS20_for_preprocessed_data"
    else:
        kilosort_repository = r""  # default path for when we aren't using any of these

    npy_matlab_repository = params[
        "npy_matlab_repository"
    ]  # r"C:\Users\labadmin\Documents\npy-matlab-master"
    catGTPath = params["catGTPath"]  # r"C:\Users\labadmin\Documents\CatGT-win-44"
    tPrime_path = params["tPrime_path"]  # r"C:\Users\labadmin\Documents\TPrime-win"
    cWaves_path = params[
        "cWaves_path"
    ]  # r"C:\Users\labadmin\Documents\C_Waves_Latest\C_Waves-win"
    ...
    if (
        kilosort_output_directory is None
    ...
    if spikeGLX_data:
        ...
        if input_meta_path is not None:
            ...
            print(
                "probe type: {:s}, sample_rate: {:.5f}, num_channels: {:d}, uVPerBit: {:.4f}".format(
                    probe_type, sample_rate, num_channels, uVPerBit
                )
            )
            print(
                "nColumns: {:d}, vpitch: {:.0f}, hpitch: {:.0f}".format(
    ...
    fproc = os.path.join(
        kilosort_output_tmp, "temp_wh.dat"
    ...
    dictionary = {
        ...
        "waveform_metrics": {
            "waveform_metrics_file": os.path.join(
                kilosort_output_directory, "waveform_metrics.csv"
            )
        },
        "cluster_metrics": {
            "cluster_metrics_file": os.path.join(
                kilosort_output_directory, "metrics.csv"
            )
        },
        "ephys_params": {
        ...
        "depth_estimation_params": {
            ...
            "figure_location": os.path.join(
                extracted_data_directory, "probe_depth.png"
            ),
            "smoothing_amount": 5,
            "power_thresh": 2.5,
            "diff_thresh": -0.06,
        ...
        "psth_events": {"event_ex_param_str": event_ex_param_str},
    }
