...
from ...common.SGLXMetaToCoords import MetaToCoords, readMeta
from ._schemas import Ks4Schema
...
def _fix_phy_params(output_dir, dat_path, dat_name, chan_phy_binary, sample_rate):
    """
...
def run_ks4(args):
    ...
    MetaToCoords(metaFullPath=meta_file, outType=1, destFullPath=str(chanmap_file))
...
def main():
    ...
    args = Ks4Schema().load({"input": input_json, "output": {}})

    output = run_ks4(args["input"])
